...
public class LECSavedCardsAdapter extends RecyclerView.Adapter<LECSavedCardsAdapter.PersonViewHolder> {

    private LECSavedCardsListener cardsListener;
    private Context context;

    private LECSavedCardsAdapter(){
    }
    public LECSavedCardsAdapter(Context context){
    ...
    List<LECStoredCard> cards;

    public LECSavedCardsAdapter(Context context, List<LECStoredCard> cards, LECSavedCardsListener cardsListener){
        this(context);
        this.cards = cards;
    ...
    public void onBindViewHolder(PersonViewHolder personViewHolder, final int i) {
        ...
        final LECStoredCard lecStoredCard = cards.get(i);
    ...
    public interface LECSavedCardsListener {
