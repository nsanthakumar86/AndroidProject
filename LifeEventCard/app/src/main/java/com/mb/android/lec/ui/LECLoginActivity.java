 ...
 */
public class LECLoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
...
//        populateAutoComplete();
        ...
        Button signupBtn = (Button) findViewById(R.id.email_sign_up_button);
   ...
   public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(LECLoginActivity.this,
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                LECUser lecUser = LECQueryManager.getUserByMailIdAndPassword(mEmail, mPassword);
                if(lecUser!= null){
                    return true;
                }
            } catch (Exception e) {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                LECSharedPreferenceManager.loggedInLECUser(LECLoginActivity.this);
                LECSharedPreferenceManager.loggedInLECUser(LECLoginActivity.this, mEmail);
                Intent intent = new Intent(LECLoginActivity.this, LECDashboard.class);
